...
public class Policy {
	...
	public Policy(String policyName, Integer policyNumber, float premium, String type, int duration, String coverage,
			String category, String brand, float sumAssured) {
		super();
